...
const Dashboard = () => {
    ...
    const paymentColumns = [
        ...
        { field: 'paymentAmount', header: 'Payment Amount', body: (data) => formatCurrency(data.paymentAmount) },
        ...
        <div className="grid">
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">{workLabel}</span>
                            <div className="text-900 font-medium text-xl">{workCount}</div>
                        </div>
                        <Button className='align-self-start' icon="pi pi-sort-alt" onClick={() => handleWorkTypeChange(workType === 'posting' ? 'booking' : 'posting')} rounded text aria-label="Filter" />
                    </div>
                    <span className="text-green-500 font-medium">{newWorkCount} new </span>
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        ...
                        <Button className='align-self-start' icon="pi pi-sort-alt" onClick={() => handleUserTypeChange(userType === 'all' ? 'household' : userType === 'household' ? 'worker' : 'all')} rounded text aria-label="Filter" />
                    </div>
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Account Validation</span>
                            <div className="text-900 font-medium text-xl">152 Uncheck</div>
                        </div>
            ...
            <div className="col-12 xl:col-6">
                <div className="card">
                    ...
                    <DataTable value={payments} selection={selectedPayment} onSelectionChange={onPaymentSelect} rows={5} paginator responsiveLayout="scroll">
                        {paymentColumns.map((column) => (
                            <Column key={column.field} field={column.field} header={column.header} sortable={true} style={{ width: '25%' }} body={column.body} />
                        ))}
                        <Column
                            header="View"
                            style={{ width: '15%' }}
                    ...
                    <ul className="list-none p-0 m-0">
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                ...
                                <div className="mt-1 text-600">Tacloban City</div>
                            </div>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Laundry and Ironing</span>
                                <div className="mt-1 text-600">Ormoc City</div>
                            </div>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Cooking</span>
                                <div className="mt-1 text-600">Calbayog City</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Childcare</span>
                                <div className="mt-1 text-600">tacloban City</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Elderly Care</span>
                                <div className="mt-1 text-600">Palo</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Pet Care</span>
                                <div className="mt-1 text-600">Baybay City</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
                ...
                <div className="card">
                    ...
                    <ul className="p-0 mx-0 mt-0 mb-4 list-none">
                        ...
                        <li className="flex align-items-center py-2">
                            ...
                            <span className="text-700 line-height-3">
                                A large number of clients or domestic workers have signed up for the app within a short period of time.
                            </span>
                        </li>
                    </ul>
                    ...
                    <ul className="p-0 m-0 list-none">
                        <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                            ...
                            <span className="text-900 line-height-3">
                                <span className="text-700"> A major update or feature has been added to the app.</span>
                            </span>
                        </li>
                        <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                            ...
                            <span className="text-900 line-height-3">
                                Juan Dela Cruz
                                <span className="text-700"> has submitted a support ticket about a refund request.</span>
                            </span>
                        </li>
                    </ul>
                </div>
